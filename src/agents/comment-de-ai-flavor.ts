...
import { runAiFlavorPass, type AiFlavorPassOptions } from 'aidcp-kernel/kernel/ai-flavor-detection.js';
import { checkWritingLanguage, writingLanguageInstruction } from 'aidcp-kernel/kernel/writing-language.js';
