...
import { isContentPortError } from 'aidcp-kernel/kernel/content-port-error.js';
...
import type { ReferenceNote, ClaimRejectReason, TriggerOutcome, BeginRewriteResult } from 'aidcp-kernel/kernel/publish-generation-types.js';
