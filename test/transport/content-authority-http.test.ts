...
import { ContentPortError, isContentPortError } from 'aidcp-kernel/kernel/content-port-error.js';
...
import type { CuratedPanelRow, CuratedTargetReader } from 'aidcp-kernel/kernel/curated-content-types.js';
import {
